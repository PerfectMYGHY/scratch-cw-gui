...
export default async function ({ addon, console }) {
  ...
  function updateLogo() {
    ...
    logo.src =
      {
        "90s": addon.self.getResource("/assets/90s-logo.svg") /* rewritten by pull.js */,
        oldTimey: addon.self.getResource("/assets/oldtimey-logo.svg") /* rewritten by pull.js */,
        prehistoric: addon.self.getResource("/assets/prehistoric-logo.svg") /* rewritten by pull.js */,
      }[mode] || initialSrc;
  }
