...
const manifest = {
  ...
  "credits": [
    ...
    {
      "name": "Ucrash",
      "link": "https://github.com/gducrash"
    }
  ],
  "customCssVariables": [
    {
    ...
    {
      "name": "page-scratchr2BackgroundImage",
      "value": {
        "type": "map",
        "source": {
          "type": "settingValue",
        ...
        "options": {
          "#fcfcfc": "url('https://cdn.scratch.mit.edu/scratchr2/static/images/scratch-bg.png')",
          "#fcfcfcff": "url('https://cdn.scratch.mit.edu/scratchr2/static/images/scratch-bg.png')"
        },
        "default": "none"
      }
    },
    ...
    {
      "name": "gray-scratchr2ProjectStatsBackground",
      "value": {
        "type": "map",
        "source": {
          "type": "settingValue",
  ...
  "settings": [
    ...
    {
      "name": "Message count in navigation bar",
      "id": "messageIndicatorColor",
      "type": "color",
      "default": "#ffab1a"
    },
    {
      "name": "Message count on Messages page",
      "id": "messageIndicatorOnMessagesPage",
      "type": "color",
      "default": "#cc4400"
    },
    {
  ...
  "presets": [
    {
      ...
      "values": {
        ...
        "messageIndicatorOnMessagesPage": "#cc4400",
        "darkBanners": "darker",
        "darkForumCode": true
      }
    },
    ...
    },
    {
      "name": "Scratch 2.0",
      "id": "scratchr2-blue",
      "description": "The colors previously used on Scratch 2.0-styled pages",
      "values": {
        "page": "#fcfcfc",
        "navbar": "#0f8bc0",
        "box": "#ffffff",
        ...
        "footer": "#ececec",
        "border": "#0000001a",
        "messageIndicatorColor": "#f9a739",
        "messageIndicatorOnMessagesPage": "#f9a739",
        "darkBanners": "off",
        "darkForumCode": false
      }
    },
    {
      "name": "Scratch 2.0 (2015)",
      "id": "scratch-oldWwwBlue",
      "description": "The colors of the home page between 2015 and 2018",
      "values": {
        "page": "#fcfcfc",
        "navbar": "#25aff4",
        "box": "#ffffff",
