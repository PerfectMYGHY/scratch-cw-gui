...
class GUI extends React.Component {
    ...
    componentDidUpdate(prevProps) {
        console.log(prevProps, this.props.projectId);
        if (this.props.projectId !== prevProps.projectId) {
                console.log("change project id!");
                console.error("TNND!WCNQJ!WSMLSZ!WYMRN!");
            console.log(new Error("TNND!WCNQJ!WSMLSZ!WYMRN!").stack);
            if (this.props.projectId !== null && this.props.projectId != 0) {
