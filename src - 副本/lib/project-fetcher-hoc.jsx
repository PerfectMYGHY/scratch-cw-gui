...
const fetchProjectToken = async (projectId,projectHost) => {
    if (projectId === '0') {
        return null;
    }
    // Parse ?token=abcdef
    ...
    try {
        const metadata = await fetchProjectMeta(projectId, projectHost);
    ...
    class ProjectFetcherComponent extends React.Component {
        ...
        fetchProject (projectId, loadingState) {
            ...
            if (projectUrl) {
                ...
                // TW: Temporary hack for project tokens
                assetPromise = fetchProjectToken(projectId, this.props.projectHost)
                    .then(token => {
